...
if (!isset($_SESSION['idUser'])) {
    ...
    if (LoginClass::check_if_geblokkeerd($_SESSION['idUser'])) {
        ...
        if (!isset($_SESSION['idUser'])) {
            ...
            echo "<h3 style='text-align: center;' >U bent niet gemachtigd en daarom niet bevoegd om deze pagina te bekijken. U wordt teruggestuurd naar de homepagina.</h3><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>";
            // echo $sessieRol;
            header("refresh:5;url=index.php?content=AlgemeneHomepage");

        } else {

        }
    } else {
        echo "<h3 style='text-align: center;' >U bent geblokkeerd, neem contact op met: beheer@WebshopCulemborg.nl om de blokkade op te heffen</h3><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>";
